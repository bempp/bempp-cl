"""Definition of the lowest order SNC localised space."""
...
class Snc0LocalisedFunctionSpace(_FunctionSpace):
    """A space of localised SNC functions."""
