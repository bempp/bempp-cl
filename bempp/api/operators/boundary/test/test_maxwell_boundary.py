...
def test_maxwell_multitrace_complex_sphere(default_parameters, helpers, device_interface, precision):
...
def test_maxwell_transmission_complex_sphere(default_parameters, helpers, device_interface, precision):
