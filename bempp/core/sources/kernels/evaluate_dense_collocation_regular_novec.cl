...
__kernel void evaluate_dense_regular(
  ...
  if (!elementsAreAdjacentCollocation(testElement, trialElement, gridsAreDisjoint)) {
    for (i = 0; i < NUMBER_OF_TEST_SHAPE_FUNCTIONS; ++i)
      for (j = 0; j < NUMBER_OF_TRIAL_SHAPE_FUNCTIONS; ++j) {
