...
__kernel void evaluate_dense_helmholtz_multitrace_vector_regular(
  ...
  REALTYPE4 shapeIntegralSingleLayer[3][3][2];
  REALTYPE4 shapeIntegralDoubleLayer[3][3][2];
  REALTYPE4 shapeIntegralAdjDoubleLayer[3][3][2];
  REALTYPE4 shapeIntegralHypersingular[3][3][2];
  REALTYPE4 shapeIntegralHypersingularFirstComp[2];
  REALTYPE4 tempShapeIntegralSingleLayer[3][2];
  REALTYPE4 tempShapeIntegralDoubleLayer[3][2];
  REALTYPE4 tempShapeIntegralAdjDoubleLayer[3][2];
  REALTYPE4 tempShapeIntegralHypersingular[2];
  REALTYPE testValue[3];
  REALTYPE trialValue[3];
  REALTYPE testInv[2][2];
  REALTYPE4 trialInv[2][2];

  REALTYPE4 tempFactorDouble[2];
  REALTYPE4 tempFactorAdj[2];
  REALTYPE4 factor1[2];
  REALTYPE4 factor2[2];
  REALTYPE4 product[2];
  ...
  REALTYPE4 shapeIntegralSingleLayerInt[3][3][2];
  REALTYPE4 shapeIntegralDoubleLayerInt[3][3][2];
  REALTYPE4 shapeIntegralAdjDoubleLayerInt[3][3][2];
  REALTYPE4 shapeIntegralHypersingularInt[3][3][2];
  REALTYPE4 shapeIntegralHypersingularFirstCompInt[2];

  REALTYPE4 tempShapeIntegralSingleLayerInt[3][2];
  REALTYPE4 tempShapeIntegralDoubleLayerInt[3][2];
  REALTYPE4 tempShapeIntegralAdjDoubleLayerInt[3][2];
  REALTYPE4 tempShapeIntegralHypersingularInt[2];
#endif
  ...
  for (vecIndex = 0; vecIndex < 4; ++vecIndex)
    if (!elementsAreAdjacent(testElement, trialElement[vecIndex],
      ...
      for (i = 0; i < 3; ++i)
        for (j = 0; j < 3; ++j) {
          localResultDirichlet[4 * lid + vecIndex][i][j][0] =
              ...
              (VEC_ELEMENT(shapeIntegralSingleLayer[i][j][0], vecIndex) *
               ...
               VEC_ELEMENT(shapeIntegralSingleLayer[i][j][1], vecIndex) *
                   localCoeffsNeumann[j][1]);
          localResultDirichlet[4 * lid + vecIndex][i][j][1] =
              -(VEC_ELEMENT(shapeIntegralDoubleLayer[i][j][0], vecIndex) *
                    localCoeffsDirichlet[j][1] +
                VEC_ELEMENT(shapeIntegralDoubleLayer[i][j][1], vecIndex) *
                    localCoeffsDirichlet[j][0]) +
          ...
          localResultNeumann[4 * lid + vecIndex][i][j][0] =
              ...
              (VEC_ELEMENT(shapeIntegralAdjDoubleLayer[i][j][0], vecIndex) *
               ...
               VEC_ELEMENT(shapeIntegralAdjDoubleLayer[i][j][1], vecIndex) *
                   localCoeffsNeumann[j][1]);
          localResultNeumann[4 * lid + vecIndex][i][j][1] =
              (VEC_ELEMENT(shapeIntegralHypersingular[i][j][0], vecIndex) *
                   localCoeffsDirichlet[j][1] +
               VEC_ELEMENT(shapeIntegralHypersingular[i][j][1], vecIndex) *
                   localCoeffsDirichlet[j][0]) +
      ...
      for (i = 0; i < 3; ++i)
        for (j = 0; j < 3; ++j) {
          localResultDirichlet[4 * lid + vecIndex][i][j][0] = M_ZERO;
          localResultDirichlet[4 * lid + vecIndex][i][j][1] = M_ZERO;

          localResultNeumann[4 * lid + vecIndex][i][j][0] = M_ZERO;
          localResultNeumann[4 * lid + vecIndex][i][j][1] = M_ZERO;
        }
    }
